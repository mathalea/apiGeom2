...
const l = figure.create('Ray', { point1: A, point2: B, shape: '|-|', thickness: 5, color: 'blue', borderSize: 0.4 })
figure.create('PointOnLine', { line: l, label: 'M', size: 0.4, thickness: 5, color: 'blue' })
