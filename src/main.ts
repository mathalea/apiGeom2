...
const O = geo.create('PointIntersectionLL', { line1: hauteur1, line2: hauteur2, label: 'O' })
const C1 = geo.create('CircleCenterPoint', { center: O, point: A, color: 'blue' })
const C2 = C1.translate({ vector: v })
geo.refreshSave()
